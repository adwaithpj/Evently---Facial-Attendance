...
class LoginView:
    def __init__(self):
        ...
        self.username_textf = ft.TextField(
            ref=self.ref_username,
            label="Username",
            width=620,
            height=68,
            text_align="left",
        ...
        self.pr = ft.ProgressRing(
            width=24, height=24, stroke_width=5, color="#57BAF5", visible=False
        )
    ...
    def view(self, page: ft.Page, params: Params, basket: Basket):
        ...
        def login(e):
            ...
            if response_status == 200:
                ...
                self.bs.title = ft.Text(
                    self.login_success.value, font_family="DM Sans Regular", size=15
                )
                ...
                ft.ResponsiveRow(
                    ...
                    controls=[
                        ...
                        ft.Container(
                            ...
                            content=ft.Column(
                                controls=[
                                    ft.Container(content=self.logo),
