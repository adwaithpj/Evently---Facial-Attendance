...
def main(page: ft.Page):
    app_routes = [
        path(url="/", clear=True, view=LoginLoadingScreen().view),
        path(url="/login", clear=False, view=LoginView().view),
        path(url="/dashboard", clear=False, view=Dashboard().view),
        path(url="/dashboardloading", clear=False, view=LoadingScreen().view),
        path(
            url="/face_recognition/:event_id",
            clear=False,
            view=Facerecognitionscreen().view,
        ),
        path(url="/gotoevent/:event_id", clear=True, view=GotoLoadingScreen().view),
        path(
            url="/gotoevent/:event_id/encoding", clear=False, view=EncodingScreen().view
        ),
    ]
