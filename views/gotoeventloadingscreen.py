...
class GotoLoadingScreen:
    ...
    def view(self, page: ft.Page, params: Params, basket: Basket):
        ...
        self.loading_pr = ft.ProgressRing(
            visible=True, width=30, height=30, stroke_width=3
        )
        self.loading_pb = ft.ProgressBar(visible=False, width=400)

        self.show_text = ft.Text(visible=True, value="Checking for Encodings")
        ...
        def show_loading(e):
            ...
            print("Checking...")
            check_participants_images = self.get_registered_users(
                self.event_id, user_token
            )
            ...
            if check_participants_images == "created_folder":
                ...
                check_participants_images == "error_in_downloading_images"
                or "no_images"
            ):
                self.show_text.visible = True
